...
export function Header() {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800/50 bg-zinc-950/95 pt-[env(safe-area-inset-top,0px)] backdrop-blur-md"
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-2 min-h-16 lg:min-h-20 py-2 lg:py-0">
            ...
            <nav className="hidden md:flex items-center gap-4 lg:gap-6 shrink-0">
              ...
              <Link href="/for-you" className="text-zinc-300 hover:text-white transition-colors text-sm font-medium">
                For You
              </Link>
              ...
              <Link href="/user" className="text-zinc-300 hover:text-white transition-colors text-sm font-medium">
                User
              </Link>
            </nav>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t border-zinc-800/50">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link href="/for-you" className="px-3 py-2 text-zinc-300 hover:text-white hover:bg-zinc-800/50 rounded-lg transition-colors">
                  For You
                </Link>
                ...
                <Link href="/user" className="px-3 py-2 text-zinc-300 hover:text-white hover:bg-zinc-800/50 rounded-lg transition-colors">
                  User
                </Link>
              </nav>
            </div>
